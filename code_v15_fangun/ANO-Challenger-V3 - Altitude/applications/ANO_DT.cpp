...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_status = 0;
		Send_Status(imu.angle.x,imu.angle.y,imu.angle.z,
								nav.ultraAlt,0,ano.f.ARMED);	
	}	
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_user)
	{
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_senser = 0;
		Send_Senser(imu.fanzhuan_angle.y,imu.Acc.y,imu.Acc.z,
								imu.Gyro_lpf.x,imu.Gyro.y,imu.Gyro.z,
								nav.velocity.z,nav.baroAlt,nav.position.z);
	}	
/////////////////////////////////////////////////////////////////////////////////////
