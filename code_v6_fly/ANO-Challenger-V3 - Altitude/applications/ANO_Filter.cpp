...
/*----------------------二阶低通滤波器系数计算-------------------------*/
void ANO_Filter::LPF_2nd_Factor_Cal(float deltaT, float Fcut, LPF2ndData_t* lpf_data)
{
...
int32_t ANO_Filter::Baro_LPF_2nd(LPF2ndData_t* lpf_2nd, float newData)
{
	float baroAlt;
...
int32_t ANO_Filter::Ultra_LPF_2nd(LPF2ndData_t* lpf_2nd, float newData)
{
	float ultraAlt;
